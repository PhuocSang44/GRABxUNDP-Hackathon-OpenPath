...
export const CATEGORY_CONFIG: Record<PointCategory, CategoryConfig> = {
  accessible_parking:  { label: "Accessible Parking",   color: "#3b82f6", textColor: "#fff", icon: "P" },
  hospital:            { label: "Hospital",              color: "#ef4444", textColor: "#fff", icon: "H" },
  accessible_toilet:   { label: "Accessible Toilet",    color: "#06b6d4", textColor: "#fff", icon: "T" },
  wheelchair_ramp:     { label: "Wheelchair Ramp",      color: "#22c55e", textColor: "#fff", icon: "R" },
  accessible_entrance: { label: "Accessible Entrance",  color: "#8b5cf6", textColor: "#fff", icon: "E" },
